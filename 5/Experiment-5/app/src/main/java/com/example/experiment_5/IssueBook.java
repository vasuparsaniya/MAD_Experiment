...
public class IssueBook extends AppCompatActivity {
    ...
    private EditText editCardNo1, editBid3;
...
//        FirebaseApp.initializeApp(this);
        ...
        editCardNo1 = (EditText) findViewById(R.id.editCardNo1);
//        db=FirebaseFirestore.getInstance();
    ...
    private boolean verifyCard() {
        String t = editCardNo1.getText().toString().trim();
        if (t.isEmpty()) {
...
//            editCardNo1.setErrorEnabled(false);
    ...
    private boolean verifyBid() {
        String t = editBid3.getText().toString().trim();
        if (t.isEmpty()) {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if (task.isSuccessful()) {
                    if (task.getResult().size() == 1) {
                        ...
                        res1 = false;
                        p.cancel();
                        Toast.makeText(IssueBook.this, "No Such User !", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    res1 = false;
                    p.cancel();
                    Toast.makeText(IssueBook.this, "Try Again !", Toast.LENGTH_SHORT).show();
                }
